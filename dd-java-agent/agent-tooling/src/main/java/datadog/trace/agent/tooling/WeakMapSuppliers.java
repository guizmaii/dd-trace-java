...
class WeakMapSuppliers {
   ...
   * second.
   */
  static class WeakConcurrentManaged implements WeakMap.Supplier {
  ...
  static class WeakConcurrentInline implements WeakMap.Supplier {
  ...
  static class Guava implements WeakMap.Supplier {
    ...
    private static class Adapter<K, V> implements WeakMap<K, V> {
      ...
      private Adapter(final ConcurrentMap<K, V> map) {
        this.map = map;
      }
