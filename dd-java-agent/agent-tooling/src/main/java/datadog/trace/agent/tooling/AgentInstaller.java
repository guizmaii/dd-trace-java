...
public class AgentInstaller {
  ...
  private static void registerWeakMapProvider() {
    WeakMap.Provider.registerIfAbsent(new WeakMapSuppliers.WeakConcurrentManaged());
    //    WeakMap.Provider.registerIfAbsent(new WeakMapSuppliers.WeakConcurrentInline());
